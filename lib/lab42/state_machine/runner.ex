defmodule Lab42.StateMachine.Runner do
  ...
  # Would be nice to have function triggers too
  ...
  defp _run_transitions(current_state, [], [input|_], _result, data, _states) do
  ...
  defp _run_normalized_transitions(current_state, [{trigger,_,_,_}=tran|trans], [input|rest], result, data, states) do
    case _match_trigger(trigger, input) do
      nil     -> _run_transitions(current_state, trans, [input|rest], result, data, states)
      matches ->
